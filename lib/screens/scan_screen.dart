              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      '01',
                      style: TextStyle(fontSize: 36, fontWeight: FontWeight.w900, color: AppTheme.textMain),
                    ),
                    const SizedBox(height: 8),
                    Container(
                      width: 64,
                      ...
                      child: const Icon(Icons.qr_code_2, size: 40, color: AppTheme.textHint), // Mock QR icon
                    ),
                  ],
                ),
              ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.nfc, color: AppTheme.primaryDark), // TODO: Replace with custom NFC SVG
          ),
